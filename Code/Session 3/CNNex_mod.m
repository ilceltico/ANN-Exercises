...
outputFolder = fullfile('Files', 'caltech101'); % define output folder
...
cnnMatFile = fullfile('Files', 'imagenet-caffe-alex.mat');
...
%convnet = helperImportMatConvNet(cnnMatFile) %old
convnet = alexnet();
...
% % Extract image features using the CNN
 imageFeatures = activations(convnet, img, featureLayer, 'OutputAs', 'columns');
% %%
% 
